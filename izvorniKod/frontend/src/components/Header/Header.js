...
const Header =()=>{
  ...
  return(
    ...
    <nav>
      ...
      <Link to="/" className="linkNoUnderline"><div className="title2"><img src="../../../logo_transparent.png" height="70" width="70"/><span className="padding">PassDirect</span></div></Link>
      ...
      <Link to="/accountmanagement"><button className="button-management" >Upravljanje računom</button></Link>
